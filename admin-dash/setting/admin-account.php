   ...
   <body>
     <header>
         ...
         <nav class="navbar navbar-expand-md navbar-dark bg-dark">
             <a href="./admin-account.php" class="navbar-brand"> <img src="../images/logo.png" alt=""> </a>
      ...
      echo"  <form  action='admin-update.php' method='POST' align=right>
      <br><br><label><b>الاسم الظاهر :</label>
          <br><br><input type='text' class='form-control' placeholder='ادخل اسمك الكامل' name='fname' value='".ucwords($result['name'])."'>
          <br><br>
          <label><b>اسم المستخدم الخاص بك : </b>".$result['user']."</label>
          <br><br>
          ...
          <input type='text' class='from-control' placeholder='ادخل تاريخ ميلادك' name='dob' value='".$result['dob']."'><br>
              ...
              <br><br>
              <a href='admin-pass.php'>تغيير كلمة المرور</a>
